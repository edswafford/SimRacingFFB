...
1. ~~**Driver feels resistance when turning into a corner** *(ITER1)*~~
...
1. ~~**System processes FFB at target rate (e.g., 360Hz)** *(ITER1)*~~
...
1. **System fades FFB in/out smoothly**
...
17. ~~**System suspends FFB when appropriate** *(ITER1)*~~
...
- *(ITER1)* Use Case 1: Driver feels resistance when turning into a corner
- *(ITER1)* Use Case 2: System processes FFB at target rate
- *(ITER1)* Use Case 17: System suspends FFB when appropriate
...
> **Use Case 1: Driver feels resistance when turning into a corner** *(ITER1)* — source: Marvin's UC1  
>
> **Use Case 2: System processes FFB at target rate (e.g., 360Hz)** *(ITER1)* — source: Marvin's UC13  
>
> **Use Case 17: System suspends FFB when appropriate** *(ITER1)* — source: Marvin's B7.1-B7.3
